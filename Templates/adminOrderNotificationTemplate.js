...
Shipping Address:
${responsePostOrder.addressId?.firstName || ""} ${responsePostOrder.addressId?.lastName || ""
    }
${responsePostOrder.addressId?.streetAddress || ""}
${responsePostOrder.addressId?.city || ""}, Zip Code: ${responsePostOrder.addressId?.zipCode || ""
    }
...
Your Online Store`;
  ...
  const html = `
    ...
    <ul>
      ...
      <li><strong>Customer Name:</strong> ${responsePostOrder.userId?.username || "N/A"
    }</li>
      <li><strong>Customer Email:</strong> ${responsePostOrder.userId?.email || "N/A"
    }</li>
      <li><strong>Customer Phone:</strong> ${responsePostOrder.userId?.mobilePhone || "N/A"
    }</li>
    </ul>
    ...
    <ul>
      <li><strong>Subtotal:</strong> PKR ${transformedResponse.orderDetails.subTotal
    }</li>
      <li><strong>Delivery Fee:</strong> PKR ${transformedResponse.orderDetails.deliveryFee
    }</li>
      <li><strong>Total Price:</strong> PKR ${transformedResponse.orderDetails.totalPrice
    }</li>
    ...
    <p>
      <strong>${responsePostOrder.addressId?.firstName || ""} ${responsePostOrder.addressId?.lastName || ""
    }</strong><br>
